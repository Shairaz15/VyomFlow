...
import { MobileAdventureMap } from './MobileAdventureMap';
...
// 2D World Landscape Positions (% left, pixel top) for Desktop Canvas (>= 768px)
...
export function JourneyMap({ 
    ...
    return (
        <div className="world-journey-wrapper" role="region" aria-label="VyomFlow World Journey Map">
            {/* =========================================================================
               1. APPROVED DESKTOP 2D WORLD MAP (>= 768px - Spacious & Cinematic)
               ========================================================================= */}
            <div className="hidden md:block world-journey-desktop-container">
            ...
            {/* =========================================================================
               2. DEDICATED MOBILE ADVENTURE MAP (< 768px - Game-Like Progression)
               ========================================================================= */}
